...
python main_mod.py --train True --ckpt_name None --testing_method unsupervised --AE True \
     ...
     --dset_dir /home/aiswarya/Columbia_WoRk/OcclusionInference/Data/20k_w_b_3to2/digts/ \
     --output_dir /home/aiswarya/Columbia_WoRk/OcclusionInference/20k_WBtrain_BWtest_3to2/AE/Unfrozen/2_digts/BLT_BLT_depth_zdim24_2 \
