python main_mod.py --train True --ckpt_name last --testing_method unsupervised --AE True \
     ...
     --dset_dir /home/aiswarya/Columbia_WoRk/OcclusionInference/Data/Hid_traverse_2dgt_border2/digts/ \
     --output_dir /home/aiswarya/Columbia_WoRk/OcclusionInference/Experiments/AE/Unfrozen/2_digts/BLT_BLT_depth_zdim24_2 \
